# Django stack for Wodby

Deploy Django on Kubernetes with Wodby. This repository contains the stack
manifests used by the public Django stack in the Wodby catalog.
