...
- [Python (Django) service](https://github.com/wodby/service-django)
...
Start from [Django boilerplate](https://github.com/wodby/django-boilerplate), or connect your own compatible source
repository.
